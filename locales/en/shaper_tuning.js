...
window.KV_LOCALES.en.shaper_tuning = {
  ...
  steps: {
    ...
    generateConfig: "4. Generate <code>[input_shaper]</code> config",
  ...
  explorer: {
    intro: "Pick any shaper type and see how it performs against the loaded capture — corner smoothing, projected <code>max_accel</code>, and the residual vibration left at each detected resonance. Seeded from the recommendation above; change the type or frequencies to compare.",
